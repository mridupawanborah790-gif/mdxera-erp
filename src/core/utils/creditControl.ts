import type { Customer, SalesChallan } from '../types/types';
import { SalesChallanStatus } from '../types/types';
...
export const evaluateCustomerCredit = ({
    ...
    const isCreditLimitEnabled = customer.enableCreditLimit === true;
