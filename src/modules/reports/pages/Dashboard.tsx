...
import type { InventoryItem, RegisteredPharmacy, Transaction, Purchase, Medicine, Customer, Distributor, AppConfigurations } from '../../../core/types/types';
import Chatbot from '../../../core/components/Chatbot'; // Import Chatbot here
