...
import type { PurchaseOrder, Distributor, RegisteredPharmacy } from '../../../core/types/types';
import PurchaseOrderTemplate from '../../../core/components/invoice-templates/PurchaseOrderTemplate';
