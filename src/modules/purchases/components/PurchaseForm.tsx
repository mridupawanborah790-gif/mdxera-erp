...
import type { Purchase, InventoryItem, Supplier, PurchaseItem, ModuleConfig, RegisteredPharmacy, PurchaseOrder, PurchaseOrderItem, SupplierProductMap, Medicine, AppConfigurations, FileInput, Transaction, LineAmountCalculationMode } from '../../../core/types/types';
...
const PurchaseForm = forwardRef<any, PurchaseFormProps>(({
    ...
    const handleSyncBill = useCallback(async () => {
        ...
        try {
            const pendingServerBills: any[] = await fetchPendingMobileBills({
                organizationId,
