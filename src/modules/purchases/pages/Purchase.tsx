...
import type { Purchase, InventoryItem, Distributor, PurchaseItem, ModuleConfig, RegisteredPharmacy, PurchaseOrder, PurchaseOrderItem, DistributorProductMap, Medicine, AppConfigurations, SupplierProductMap, Supplier, FileInput } from '../../../core/types/types';
...
import MobileSyncModal from '../../../core/components/MobileSyncModal';
import LinkToMasterModal from '../../inventory/components/LinkToMasterModal';
        ...
        <div className={`flex flex-col h-full bg-app-bg overflow-hidden relative ${className || ''}`} onKeyDown={handleEnterToNextField}>
            ...
            {isLinkModalOpen && currentDistributor && (
                <LinkToMasterModal
                    ...
                    onLink={onSaveMapping} scannedItems={items} onFinalize={(reconciled: PurchaseItem[]) => { setItems(reconciled); setIsLinkModalOpen(false); }} onAddMedicineMaster={onAddMedicineMaster} organizationId={organizationId}
                />
            )}
