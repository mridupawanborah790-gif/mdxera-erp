...
import type { Category, SubCategory, Promotion, InventoryItem, RegisteredPharmacy } from '@core/types';
import AddCategoryModal from '@modules/configuration/components/AddCategoryModal';
import AddSubCategoryModal from '@modules/configuration/components/AddSubCategoryModal';
import AddPromotionModal from '@modules/configuration/components/AddPromotionModal';
