...
import BarcodeScannerModal from '../../../core/components/BarcodeScannerModal';
import type { InventoryItem, Medicine, PhysicalInventorySession, PhysicalInventoryCountItem } from '../../../core/types/types';
import { PhysicalInventoryStatus } from '../../../core/types/types';
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {completedSessions.map((s, idx) => (
                                <tr key={s.id} className="hover:bg-primary hover:text-white group transition-colors cursor-pointer" onClick={() => onViewSession(s)}>
                                    ...
                                    <td className="p-2 border-r border-gray-200 font-mono font-bold text-primary group-hover:text-white uppercase">{s.voucher_no || s.id}</td>
