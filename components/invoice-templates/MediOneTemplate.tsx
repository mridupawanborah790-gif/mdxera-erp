...
const MediOneTemplate: React.FC<TemplateProps> = ({ bill, orientation = 'portrait' }) => {
  ...
  return (
    <div className="bg-white text-black font-sans w-full mx-auto leading-tight min-h-full flex flex-col antialiased border border-gray-200" style={{ fontSize: '8.5pt' }}>
      <style>{`
        @media print {
          @page { 
        ...
        .med-table th { border: 1px solid black; padding: 2px 4px; font-weight: 800; font-size: 7.5pt; text-transform: uppercase; background: #f8f9fa; }
        .med-table td { border-left: 1px solid black; border-right: 1px solid black; padding: 2px 4px; font-size: 8.5pt; height: 22px; }
        .med-table tfoot td { border-top: 1px solid black; font-weight: 800; }
            ...
            <tbody>
              {chunk.map((item, idx) => (
                <tr key={item.id}>
                  ...
                  <td className="font-black uppercase truncate">{item.name}</td>
                  ...
                  <td className="text-right font-black">{(item.lineTotal || 0).toFixed(2)}</td>
                </tr>
              ))}
          ...
          {pageIdx === calculations.itemChunks.length - 1 && (
            <div className="mt-2 flex flex-col">
              <div className="flex justify-between items-start border border-black p-2 bg-gray-50">
                  <div className="flex-1">
                      <p className="text-[7.5pt] font-black uppercase italic leading-tight">
                  ...
                  <div className="w-[140px] space-y-1 text-[8.5pt]">
                      ...
                      <div className="flex justify-between font-black text-blue-900 border-t border-black pt-1 text-[11pt]">
                          <span>NET AMT:</span>
              ...
              <div className="mt-4 flex justify-between items-end px-1">
                  ...
                  <div className="text-center min-w-[150px]">
                      <p className="text-[7pt] font-black uppercase mb-6">For {bill.pharmacy.pharmacy_name}</p>
                      <p className="border-t border-black pt-1 px-4 text-[8pt] font-black uppercase">Auth. Signatory</p>
                  </div>
              </div>
            </div>
          )}
