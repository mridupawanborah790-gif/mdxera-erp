...
const PurchaseForm = forwardRef<any, PurchaseFormProps>(({
    ...
    const handleGlobalKeyDown = useCallback((e: KeyboardEvent) => {
        if (isSearchModalOpen || isWebcamModalOpen || isAddSupplierModalOpen || isAddMedicineMasterModalOpen || isEditMaterialModalOpen || isLinkModalOpen || isRateTierModalOpen || isSupplierSearchModalOpen) return;
    ...
    }, [activeRowId, items, isSearchModalOpen, isWebcamModalOpen, isAddSupplierModalOpen, isAddMedicineMasterModalOpen, isEditMaterialModalOpen, isLinkModalOpen, isRateTierModalOpen, isSupplierSearchModalOpen, triggerSaveAction]);
