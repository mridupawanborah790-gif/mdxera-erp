...
const getPrimaryTextModels = (): string[] => ['gemini-2.5-flash', 'gemini-2.0-flash', 'gemini-1.5-flash', 'gemini-1.5-pro'];
...
export const getAiInsights = async (summary: any): Promise<string[]> => {
    try {
        ...
        const response = await generateWithModelFallback(getPrimaryTextModels(), {
            contents: prompt,
            config: {
